...
public class StringUtil {
	 ...
	 * @author ymy
	 */
	public static boolean objectIsEmtpy(Object o){
		boolean flag = false;
		if(o == null){
			flag = true;
		}
	...
	/**
	 * @Title getStringValues
	 * @Description 获取字符串
	 * @param list
	 * @return String
	 * @date 2015年5月27日 上午8:38:47
	 */
	public static String strList2Str(List<String> list){
		...
		if(list != null && list.size()>0){
			...
			reStr = temp.substring(0, temp.length()-1);
		}else{
			reStr = null;
		}
		return reStr;
	...
	public static String strArr2Str(String[] strArray){
		StringBuilder sb = new StringBuilder();
		String reStr = "";
	...
	public static String getFormatDate(Date date){
		if(date != null){
			return DateUtils.date_sdf.format(date);
		}
		return "";
	}
	
	public static String getStringValue(Integer arg){
		if(arg != null){
	...
	public static boolean checkVerdict(String verdict){
		if("1".equals(verdict)){
			return true;
		}
		return false;
